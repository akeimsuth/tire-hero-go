...
const CustomerDashboard = () => {
  ...
  const getRecentRequests = async () => {
    const data = await serviceRequestAPI.getAllCompleted();
  ...
  return (
    ...
    //         <Button onClick={logoutFunc} variant="outline" size="sm">
    //           Logout
    //         </Button>
    //       </div>
    //     </div>
    ...
    //                       </div>
    //                       <Badge
    //                         className={getStatusColor(request?.tireStatus)}
    //                       >
    //                         {request?.tireStatus}
    //                       </Badge>
    //                     </div>

    //                     {request?.tireStatus === "Bids Open" && (
    ...
    //             <CardDescription>Your completed tire requests</CardDescription>
    //           </CardHeader>
    //           <CardContent>
    //             {!recentJobs.length ? (
    //               <div className="text-center py-8">
    //                 <p className="text-gray-500 mb-4">No recent requests</p>
    //               </div>
    //             ) : (
    //               <div className="space-y-4">
    //                 {recentJobs.map((job) => (
    ...
    //                           ))}
    //                         </div>
    //                         <p className="font-semibold">${job?.cost || 120}</p>
    //                       </div>
    //                     </div>
    //                   </div>
    //                 ))}
